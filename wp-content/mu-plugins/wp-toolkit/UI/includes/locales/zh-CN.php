...
$messagesBackend = [
    ...
    'plugin.noJsText' => '请启用浏览器中的 JavaScript 以使用此插件。',

    'dashboard.widget.vulnerabilities.title' => '{productName}：站点漏洞',
    'dashboard.widget.attacks.title' => '漏洞保护',
    'dashboard.widget.noJsText' => '请启用浏览器中的 JavaScript 以访问此小部件。',
];

$messagesFrontend = [
    'backgroundTasksContext.polling.error' => '无法查询后台任务',
    'dateTimeDisplay.format' => '{tense, select, past{{timeCategory, select, minutes{{minutes, plural, =0{不到一分钟前} other{约 {minutes} 分钟前}}} hours{{hours, plural, =0{不到一小时前} other{约 {hours} 小时前}}} other{{dateTime, date, medium} {dateTime, time, short}}}} future{{timeCategory, select, minutes{{minutes, plural, =0{一分钟内} other{约 {minutes} 分钟内}}} hours{{hours, plural, =0{一小时内} other{约 {hours} 小时内}}} other{{dateTime, date, medium} {dateTime, time, short}}}} other{{dateTime, date, medium} {dateTime, time, short}}}',
    'ellipsisText.showLess' => '显示更少',
    'ellipsisText.showMore' => '显示更多',
    'loader.text.dataLoading' => '正在加载数据',
    'loader.text.dataSaving' => 'Saving data',
    'loader.text.mitigationUpdate' => '正在更新站点组件，请稍候',
    'loader.text.mitigationDisable' => '正在停用漏洞组件，请稍候',
    ...
    'smartUpdateEnabled.confirmation.text' => '本站点已启用 Smart Updates，因此更新可能需要一段时间。您想要继续吗？',
    'smartUpdateEnabled.confirmation.button.confirm' => '运行 Smart Update',
    'smartUpdateEnabled.confirmation.button.reject' => '取消',
    'toast.error.defaultTitle' => '出现一个错误',
    'toast.error.installationProperties' => '读取站点属性失败',
    'toast.error.accessToken' => '未找到插件访问令牌。请尝试在控制面板界面中对应站点的设置屏幕上刷新访问令牌，或联系您的服务提供商寻求帮助。',
    'vulnerabilitiesWidget.activeVulnerabilities.label' => '{counter, plural, other {个未解决的漏洞}}', // Attention! This string shouldn't contain number placeholder (#) itself
    'vulnerabilitiesWidget.activeVulnerabilities.tooltip' => '您站点上未解决的漏洞数量，不包括已忽略的漏洞。',
    'vulnerabilitiesWidget.activeVulnerabilities.empty.title' => '您的网站上没有未解决的漏洞',
    'vulnerabilitiesWidget.activeVulnerabilities.empty.subtitle' => '请确保您的站点已启用漏洞保护功能，以保障网站安全',
    'vulnerabilitiesWidget.risk.critical' => '重大风险',
    'vulnerabilitiesWidget.risk.high' => '高风险',
    'vulnerabilitiesWidget.risk.medium' => '中风险',
    'vulnerabilitiesWidget.risk.low' => '低风险',
    'vulnerabilitiesWidget.counter.fixed.label' => '{counter, plural, other {个已缓解的漏洞}}', // Attention! This string shouldn't contain number placeholder (#) itself
    'vulnerabilitiesWidget.counter.fixed.tooltip' => '通过漏洞保护或组件停用来缓解网站漏洞的数量。',
    'vulnerabilitiesWidget.counter.fixed.emptyText' => '自动应用保护规则',
    'vulnerabilitiesWidget.counter.attacks.label' => '{counter, plural, other {次攻击已阻止}}', // Attention! This string shouldn't contain number placeholder (#) itself
    'vulnerabilitiesWidget.counter.attacks.tooltip' => '过去 365 天内，您站点已阻止的利用漏洞攻击的尝试次数。',
    'vulnerabilitiesWidget.counter.attacks.emptyText' => '我们实时跟踪漏洞，并根据漏洞被利用的可能性确定其优先级。', // unused
    'vulnerabilitiesWidget.somethingNotProtected' => '保护已开启，但仍有漏洞未缓解？',
    'vulnerabilityList.bulkActions.selected' => '{count, plural, =0 {未选择任何漏洞} other {# 个已选择}}',
    'vulnerabilityList.bulkActions.update' => '更新',
    'vulnerabilityList.searchField.label' => '搜索',
    ...
    'settings.analytics.idNotAvailable' => '不可用',
    'settings.analytics.copyToClipboard.buttonLabel' => 'Copy Analytics ID',
    'settings.analytics.copyToClipboard.idNotAvailable' => '分析 ID 不可用',
    'settings.analytics.copyToClipboard.toast.success' => '分析 ID 已复制到剪贴板',
    'settings.analytics.copyToClipboard.toast.error' => '复制分析 ID 到剪贴板失败',
    ...
    'settings.consent.toast.success.optedIn' => '您已同意收集用户分析数据',
    'settings.consent.toast.success.optedOut' => '您不同意收集用户分析数据',
    'settings.consent.toast.error.optedInStatus' => '更新分析选择同意/不同意状态失败',
    'settings.accessToken.title' => '访问令牌',
    'settings.accessToken.description' => '此访问令牌为本网站所独有。它允许此插件与 WP Toolkit（为插件提供支持）通信。令牌每 24 小时自动刷新一次。如有需要，您可以在此处或 WP Toolkit 界面的设置屏幕上手动刷新。',
    'settings.accessToken.description.customAppName' => "此访问令牌为本网站独有。它允许此插件与服务后台进行通信。令牌每 24 小时自动刷新一次。如有必要，您可以在此处手动更新。如果令牌更新失败，请联系服务提供商寻求帮助。",
    'settings.accessToken.lastRefresh' => 'Last refresh',
    'settings.accessToken.lastRefresh.unavailable' => '不可用',
    'settings.accessToken.lastRefresh.dateTimeFormat' => '{dateTime, date, medium} {dateTime, time, short}',
    'settings.accessToken.refreshButton' => '刷新令牌',
    'settings.accessToken.refreshing' => '正在签发新的访问令牌',
    'settings.accessToken.refreshSuccess' => '已签发新的访问令牌',
    'settings.accessToken.refreshError' => '签发新的访问令牌失败',
    'settings.error.unknownInstallation' => '未知 WordPress 安装实例 ID。请尝试在控制面板界面中对应站点的设置屏幕上刷新插件访问令牌，或联系您的服务提供商寻求帮助。',
    'pageHeader.settings' => '设置',
    ...
    'vulnerabilityList.vulnerabilityTable.disableButton.active.tooltip' => '停用会影响站点功能。',
    'vulnerabilityList.vulnerabilityTable.disableButton.inactive.tooltip' => '此插件处于非活动状态。',
    'vulnerabilityList.vulnerabilityTable.emptyState.text.protectionDisabled' => '此站点没有已知漏洞',
    'vulnerabilityList.vulnerabilityTable.emptyState.text.protectionEnabled' => '此站点存在的所有漏洞均已缓解',
    'vulnerabilityList.filtersPanel.chip.affectedPart.core' => '核心',
    'vulnerabilityList.filtersPanel.chip.affectedPart.plugin' => '插件',
    'vulnerabilityList.filtersPanel.chip.affectedPart.theme' => '主题',
    'vulnerabilityList.filtersPanel.chip.protected' => '已缓解',
    'vulnerabilityList.filtersPanel.chip.notProtected' => '未缓解',
    'vulnerabilityList.filtersPanel.chip.risk.low' => '低风险',
    'vulnerabilityList.filtersPanel.chip.risk.medium' => '中风险',
    'vulnerabilityList.filtersPanel.chip.risk.high' => '高风险',
    'vulnerabilityList.filtersPanel.chip.risk.critical' => '重大风险',
    'vulnerabilityList.filtersPanel.chip.updatesAvailable' => '可用更新',
    'vulnerabilityList.filtersPanel.chip.noUpdates' => '无更新',
    'vulnerabilityList.filtersPopover.button.apply' => '应用过滤器',
    'vulnerabilityList.filtersPopover.button.reset' => '重置过滤器',
    'vulnerabilityList.filtersPopover.header' => '过滤漏洞',
    ...
    'vulnerabilityList.filtersPopover.filter.affectedPart.plugin' => '插件',
    'vulnerabilityList.filtersPopover.filter.affectedPart.theme' => '主题',
    'vulnerabilityList.filtersPopover.filter.protection.title' => '已通过保护缓解',
    'vulnerabilityList.filtersPopover.filter.protection.protected' => '已缓解',
    'vulnerabilityList.filtersPopover.filter.protection.notProtected' => '未缓解',
    'vulnerabilityList.filtersPopover.filter.riskLevel.title' => '风险等级',
    'vulnerabilityList.filtersPopover.filter.riskLevel.low' => '低风险',
    'vulnerabilityList.filtersPopover.filter.riskLevel.medium' => '中风险',
    'vulnerabilityList.filtersPopover.filter.riskLevel.high' => '高风险',
    'vulnerabilityList.filtersPopover.filter.riskLevel.critical' => '重大风险',
    'vulnerabilityList.filtersPopover.filter.updates.title' => '更新',
    'vulnerabilityList.filtersPopover.filter.updates.available' => '可用',
    'vulnerabilityList.filtersPopover.filter.updates.notAvailable' => '不可用',
    'vulnerabilityList.vulnerabilityTable.header.risk.label' => '风险',
    'vulnerabilityList.vulnerabilityTable.header.risk.tooltip' => '风险等级是漏洞影响的综合评级。它基于 CVSS 评级、EPSS 评级、Patchstack 补丁优先级和其他因素。',
    'vulnerabilityList.vulnerabilityTable.header.vulnerability' => '漏洞',
    'vulnerabilityList.vulnerabilityTable.header.where' => '位置',
    'vulnerabilityList.vulnerabilityTable.header.howToFix' => '如何修复',
    'vulnerabilityList.vulnerabilityTable.protectedChip.tooltip' => '漏洞保护已应用保护规则来缓解此漏洞。',
    'vulnerabilityList.vulnerabilityTable.sorting.asc' => '升序排序',
    'vulnerabilityList.vulnerabilityTable.sorting.desc' => '降序排序',
    ...
    'vulnerabilityProtection.vulnerabilitiesFetch.error' => '加载站点漏洞数据失败',
    'vulnerabilityProtection.tasksLoading.error' => '从服务器更新数据失败',
    ...
    'vulnerabilityProtectionDashboard.subtitle' => '在您站点上发现的漏洞列表。',
    'vulnerabilityProtectionDashboard.lastUpdate' => '上一次更新：{dateTime}。',
    'vulnerabilityProtectionDashboard.ignoreLowLevel.title' => '忽略低风险漏洞',
    'vulnerabilityProtectionDashboard.ignoreLowLevel.tooltip' => '在应用安全策略和发送通知时，忽略低风险漏洞会将其视为已解决的漏洞。',
    'vulnerabilityProtectionDashboard.vulnerabilitiesStatisticsFetch.error' => '加载站点漏洞统计数据失败',
    'vulnerabilityProtectionDashboard.vulnerabilitiesFilteringStatusUpdate.error' => '更新站点漏洞过滤器状态数据失败',
    'vulnerabilityProtectionDashboard.protectionInfo.header' => "缓解漏洞需要特定的保护规则。以下是无法使用特定漏洞保护规则的原因：",
    'vulnerabilityProtectionDashboard.protectionInfo.poweredBy' => '技术基于',
    'vulnerabilityProtectionDashboard.protectionInfo.noPatch.title' => '正在进行中的任务',
    'vulnerabilityProtectionDashboard.protectionInfo.noPatch.description' => '针对高影响漏洞的规则通常在漏洞披露后数小时内公布。影响较小漏洞的规则可能需要更长的时间才能创建。',
    'vulnerabilityProtectionDashboard.protectionInfo.unlikelyExploited.title' => '低风险',
    'vulnerabilityProtectionDashboard.protectionInfo.unlikelyExploited.description' => '有些漏洞的影响很小，或者缺乏真正的利用方法。由于它们不会对网站构成真正的威胁，因此没有必要制定保护规则。',
    'vulnerabilityProtectionDashboard.protectionInfo.dbMatch.title' => '数据库中缺少',
    'vulnerabilityProtectionDashboard.protectionInfo.dbMatch.description' => '仅存在于 Wordfence 数据库或与 Patchstack 数据库中相应条目不匹配的漏洞不会收到保护规则。',
    ...
    'vulnerabilityMitigation.disable.successMessage' => '漏洞插件已停用',
    'vulnerabilityMitigation.disable.errorMessage' => '停用插件失败',
    'vulnerabilityMitigation.update.successMessage' => '更新已安装',
    'vulnerabilityMitigation.update.errorMessage' => '安装更新失败',
    ...
    'widget.attacks.attacksCounter.label' => '{counter, plural, other {次攻击已阻止}}', // Attention! This string shouldn't contain number placeholder (#) itself
    'widget.attacks.attacksCounter.tooltip' => '过去 365 天内，您站点已阻止的利用漏洞攻击的尝试次数。',
    'widget.attacks.goToPluginButton.text' => '查看详情',
    'widget.vulnerabilities.vulnerabilitiesDisplay.totalCounter.label' => '{counter, plural, other {个 WordPress 漏洞已找到}}', // Attention! This string shouldn't contain number placeholder (#) itself
    'widget.vulnerabilities.vulnerabilitiesDisplay.barLabel.critical' => '{count, plural, other {{displayedNumber} 个重大风险}}', // {displayedNumber} might contain, for example, '2.3k'; in that case {count} will be 2300
    'widget.vulnerabilities.vulnerabilitiesDisplay.barLabel.high' => '{count, plural, other {{displayedNumber} 个高风险}}', // {displayedNumber} might contain, for example, '2.3k'; in that case {count} will be 2300
    'widget.vulnerabilities.vulnerabilitiesDisplay.barLabel.medium' => '{count, plural, other {{displayedNumber} 个中风险}}', // {displayedNumber} might contain, for example, '2.3k'; in that case {count} will be 2300
    'widget.vulnerabilities.vulnerabilitiesDisplay.barLabel.low' => '{count, plural, other {{displayedNumber} 个低风险}}', // {displayedNumber} might contain, for example, '2.3k'; in that case {count} will be 2300
    'widget.vulnerabilities.goToPluginButton.text' => '查看详情',
    'widget.vulnerabilities.empty.title' => '您的网站上没有未解决的漏洞',
    'widget.vulnerabilities.empty.subtitle' => '请确保您的站点已启用漏洞保护功能，以保障网站安全',
    'widget.vulnerabilities.loadingFailed' => '加载漏洞数据失败',
    'widget.vulnerabilities.error.installationResponseEmpty' => '加载站点属性失败',
    'widget.vulnerabilities.error.vulnerabilitiesResponseEmpty' => '没有关于此站点漏洞的信息',
    'wpPart.core' => '核心',
    'wpPart.plugin' => '插件',
    'wpPart.theme' => '主题',
    ...
    'purchaseProtectionDialog.wpt.initial.title' => '漏洞保护',
    ...
    'purchaseProtectionDialog.custom.initial.title' => '漏洞保护',
    ...
    'subscriptionsPage.vpCard.title' => '漏洞保护',
